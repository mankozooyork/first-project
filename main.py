...
# 学習用データ
flags.DEFINE_string('train', './training/data-ramdom.txt', 'File name of train data')

# 検証用テストデータ
flags.DEFINE_string('test', './test/data-ramdom.txt', 'File name of test data')
...
if __name__ == '__main__':
  ...
  cpath = os.getcwd()
  save_path = saver.save(sess, cpath + '/model2.ckpt')
